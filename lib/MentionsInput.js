...
var _initialiseProps = function _initialiseProps() {
  ...
  this.handleChange = function (ev) {
    ...
    var currentDocument = document.activeElement.contentDocument || document;
  ...
  this.updateMentionsQueries = function (plainTextValue, caretPosition) {
    ...
    var value = _this2.props.value || "";
    if (_utils2.default.isInsideOfMention(value, _this2.props.markup, caretPosition, _this2.props.displayTransform) || _utils2.default.isInsideOfMention(value, _this2.props.markup, caretPosition - 1, _this2.props.displayTransform)) {
      return;
    }
  ...
  this.addMention = function (suggestion, _ref2) {
